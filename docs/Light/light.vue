<template>
  <div>
    ...
    <div class="btn">
      <button class="custom-btn btn-3" @click="setLight">
        <span>场景光</span>
      </button>
      <button class="custom-btn btn-6" @click="setSkyLight">
        <span>半球光</span>
      </button>
      <button class="custom-btn btn-16" @click="setDirectional">
        <span>平行光</span>
      </button>
      <button class="custom-btn btn-8" @click="setPoint">
        <span>点光源</span>
      </button>
    </div>
    <div class="btn">
      <button class="custom-btn btn-3" @click="setSpot">
        <span>聚光灯</span>
      </button>
      <button class="custom-btn btn-6" @click="setRect">
        <span>区域光</span>
      </button>
      <button class="custom-btn btn-16" @click="setRectBox">
        <span>光盒</span>
      </button>
      <button class="custom-btn btn-8" @click="setRectBoxNoHelper">
        <span>无辅助光盒</span>
      </button>
    </div>
  </div>
...
const setDirectional = () => {
  sceneA.setDirectional();
};
const setPoint = () => {
  sceneA.setPoint();
};
...
const setRectBoxNoHelper = () => {
  sceneA.setRectBoxNoHelper();
};
//切换场景
const setScene = (scene: number) => {
  switch (scene) {
    case 5:
      ...
      transitionText.value = "灯光";
      sceneA.flyTo({
        position: [36.6, 80.6, 328.1],
        controls: [0, 0, 0],
        duration: 2000,
      });
