<template>
  <div>
    ...
    <div class="btn">
      <button class="custom-btn btn-12" @click="setHdr">
        <span>Click!</span><span>hdr贴图</span>
      </button>
      <button class="custom-btn btn-12" @click="setExr">
        <span>Click!</span><span>exr贴图</span>
      </button>
    </div>
  </div>
</template>
